...
window.updateAPIKeyToFirestore = async (e) =>
  new Promise(async (t, s) => {
    const o = getFirestore(window.appInstance),
      w = doc(o, "users", window.userState.uid);
    await setDoc(w, { apiKey: e }, { merge: !0 })
      .then(() => {
...
window.updateOnboardedStatus = async () =>
  new Promise(async (e, t) => {
    const s = getFirestore(window.appInstance),
      o = doc(s, "users", window.userState.uid);
    await setDoc(o, { onboarded: !0 }, { merge: !0 })
      .then(() => {
...
window.updateWebsites = async (e) =>
  new Promise(async (t, s) => {
    const o = getFirestore(window.appInstance),
      w = doc(o, "users", window.userState.uid);
    await setDoc(w, { websites: e }, { merge: !0 })
      .then(() => {
