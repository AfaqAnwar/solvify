  ...
  buildLogMessage_ = function (...e) {
    ...
    for (let n = 0; n < e.length; n++) {
      ...
      (r && "object" == typeof r && "number" == typeof r.length)
        ? (t += buildLogMessage_.apply(null, r))
        : (t += "object" == typeof r ? stringify(r) : r),
        (t += " ");
    }
    return t;
  };
...
const enableLogging$1 = function (e, t) {
    assert(
      ...
      !0 === e
        ? ((m.logLevel = a.VERBOSE),
          (y = m.log.bind(m)),
          t && _.set("logging_enabled", !0))
        : "function" == typeof e
        ? (y = e)
        : ((y = null), _.remove("logging_enabled"));
  },
  log = function (...e) {
    if (
      (!0 === g &&
      ...
      (function (e) {
        if ("complete" === document.readyState) e();
          ...
          document.addEventListener
            ? (document.addEventListener("DOMContentLoaded", wrappedFn, !1),
              window.addEventListener("load", wrappedFn, !1))
    ...
    if (this.shouldReconnect_()) {
      ...
      try {
        ...
        this.log_("Failed to get token: " + e),
          o || (this.repoInfo_.nodeAdmin && warn(e), closeFn());
      }
    }
  }
  interrupt(e) {
...
class LeafNode {
  ...
  hash() {
    if (null === this.lazyHash_) {
      ...
      this.priorityNode_.isEmpty() ||
        (e += "priority:" + priorityHashText(this.priorityNode_.val()) + ":");
      const t = typeof this.value_;
      (e += t + ":"),
        (e +=
          "number" === t ? doubleToIEEE754String(this.value_) : this.value_),
  ...
  compareToLeafNode_(e) {
    ...
    return (
      assert(r >= 0, "Unknown leaf type: " + t),
...
class Base12Num {
  constructor(e) {
    var t;
    (this.count = ((t = e + 1), parseInt(Math.log(t) / F, 10))),
  ...
  const buildBalancedTree = function (t, r) {
    ...
    i = (function (t) {
      ...
      for (let e = 0; e < t.count; ++e) {
        ...
        n
          ? buildPennant(r, LLRBNode.BLACK)
          : (buildPennant(r, LLRBNode.BLACK), buildPennant(r, LLRBNode.RED));
      }
      return i;
...
class IndexMap {
  ...
  static get Default() {
    return (
      assert(D && x, "ChildrenNode.ts has not been loaded"),
      (O = O || new IndexMap({ ".priority": D }, { ".priority": x })),
      O
    );
  }
  get(e) {
  ...
  addToIndexes(e, t) {
    const n = map(this.indexes_, (n, r) => {
      ...
      }
      {
        ...
        let i = n;
        return (
          r && (i = i.remove(new NamedNode(e.name, r))), i.insert(e, e.node)
        );
      }
    });
...
class ChildrenNode {
  ...
  updateImmediateChild(e, t) {
    if (
      (assert(t, "We should always be passing snapshot nodes"),
      ".priority" === e)
    )
  ...
  val(e) {
    ...
    let n = 0,
      ...
      i = !0;
    if (
      (this.forEachChild(x, (o, s) => {
        (t[o] = s.val(e)),
          n++,
          i && ChildrenNode.INTEGER_REGEXP_.test(o)
  ...
  hash() {
    if (null === this.lazyHash_) {
      let e = "";
      this.getPriority().isEmpty() ||
        (e += "priority:" + priorityHashText(this.getPriority().val()) + ":"),
...
Object.defineProperties(NamedNode, {
  MIN: { value: new NamedNode(v, ChildrenNode.EMPTY_NODE) },
  MAX: { value: new NamedNode(C, M) },
}),
  ...
  }
  {
    ...
    if (r) {
      ...
      return new ChildrenNode(
        i,
        nodeFromJSON(t),
        new IndexMap({ ".priority": e }, { ".priority": x })
      );
    }
...
class LimitedFilter {
    ...
    if (t.isLeafNode() || t.isEmpty())
      ...
      for (; e.hasNext(); ) {
        ...
        this.withinDirectionalEnd(t)
          ? n++
          : (r = r.updateImmediateChild(t.name, ChildrenNode.EMPTY_NODE));
      }
    }
  ...
  fullLimitUpdateChild_(e, t, n, r, i) {
    ...
    if (s.hasChild(t)) {
      ...
      if (h && !n.isEmpty() && d >= 0)
        return (
          null != i && i.trackChildChange(changeChildChanged(t, n, e)),
        ...
        );
      {
        ...
        return null != c && this.rangedFilter_.matches(c)
          ? (null != i && i.trackChildChange(changeChildAdded(c.name, c.node)),
...
class QueryParams {
  ...
  getLimit() {
    return (
      assert(this.limitSet_, "Only valid if limit has been set"), this.limit_
    );
  }
  getIndex() {
    return this.index_;
...
function queryParamsToRestQueryStringParameters(e) {
  ...
  if (
    (e.index_ === x
      ...
      : e.index_ === b
      ? (n = "$key")
      : (assert(e.index_ instanceof PathIndex, "Unrecognized index type!"),
        (n = e.index_.toString())),
...
function sparseSnapshotTreeForEachTree(e, t, n) {
  null !== e.value
    ? n(t, e.value)
    : (function sparseSnapshotTreeForEachChild(e, t) {
...
class ImmutableTree {
  ...
  findRootMostMatchingPathAndValue(e, t) {
    ...
    if (pathIsEmpty(e)) return null;
    {
      ...
      if (null !== r) {
        ...
        if (null != i) {
          return { path: pathChild(new Path(n), i.path), value: i.value };
        }
        return null;
      }
      return null;
  ...
  set(e, t) {
    ...
    {
      const n = pathGetFront(e),
        r = (this.children.get(n) || new ImmutableTree(null)).set(
          pathPopFront(e),
          t
        ),
  ...
  setTree(e, t) {
    ...
    {
      const n = pathGetFront(e),
        r = (this.children.get(n) || new ImmutableTree(null)).setTree(
          pathPopFront(e),
          t
        );
      let i;
...
function compoundWriteAddWrite(e, t, n) {
  if (pathIsEmpty(t)) return new CompoundWrite(new ImmutableTree(n));
  {
    ...
    if (null != r) {
      ...
      return (
        (o = o.updateChild(s, n)), new CompoundWrite(e.writeTree_.set(i, o))
      );
    }
    {
...
function compoundWriteChildCompoundWrite(e, t) {
  if (pathIsEmpty(t)) return e;
  {
    ...
    return new CompoundWrite(
      null != n ? new ImmutableTree(n) : e.writeTree_.subtree(t)
    );
  }
}
      ...
      t.children.inorderTraversal((t, i) => {
        ".priority" === t
          ? (assert(
            ...
            (r = i.value))
          : (n = applySubtreeWrite(pathChild(e, t), i, n));
      }),
      n.getChild(e).isEmpty() ||
        null === r ||
        (n = n.updateChild(pathChild(e, ".priority"), r)),
      n
    );
  }
}
...
function writeTreeRemoveWrite(e, t) {
  ...
  for (; i && s >= 0; ) {
    ...
    t.visible &&
      (s >= n && writeTreeRecordContainsPath_(t, r.path)
        ? (i = !1)
        : pathContains(r.path, t.path) && (o = !0)),
      s--;
  }
  if (i) {
    if (o)
    ...
    if (r.snap)
      ...
      each(r.children, (t) => {
        e.visibleWrites = compoundWriteRemoveWrite(
          e.visibleWrites,
          pathChild(r.path, t)
        );
      });
      ...
      if (o.snap)
        pathContains(n, e)
          ? ((t = newRelativePath(n, e)),
            (r = compoundWriteAddWrite(r, t, o.snap)))
          : pathContains(e, n) &&
            ((t = newRelativePath(e, n)),
        ...
        if (pathContains(n, e))
          ...
          if (((t = newRelativePath(e, n)), pathIsEmpty(t)))
  ...
  if (r || i) {
    ...
    if (i || null != n || compoundWriteHasCompleteWrite(o, newEmptyPath())) {
      ...
      return compoundWriteApply(
        writeTreeLayerTree_(e.allWrites, filter, t),
        n || ChildrenNode.EMPTY_NODE
      );
    }
    return null;
...
function writeTreeRefCalcCompleteEventChildren(e, t) {
  return (function writeTreeCalcCompleteEventChildren(e, t, n) {
    ...
    if (n) {
      ...
      return (
        n.forEachChild(x, (e, t) => {
          const n = compoundWriteApply(
            compoundWriteChildCompoundWrite(i, new Path(e)),
            t
          );
...
function viewProcessorApplyOperation(e, t, n, r, i) {
  ...
  if (n.type === q.OVERWRITE) {
    const l = n;
    l.source.fromUser
      ? (s = viewProcessorApplyUserOverwrite(e, t, l.path, l.snap, r, i, o))
      : (assert(l.source.fromServer, "Unknown source."),
        (a =
          l.source.tagged ||
          (t.serverCache.isFiltered() && !pathIsEmpty(l.path))),
        (s = viewProcessorApplyServerOverwrite(
          e,
          t,
          l.path,
          l.snap,
    ...
    const l = n;
    l.source.fromUser
      ? (s = (function viewProcessorApplyUserMerge(e, t, n, r, i, o, s) {
          let a = t;
          return (
            r.foreach((r, l) => {
              const h = pathChild(n, r);
              viewProcessorCacheHasChild(t, pathGetFront(h)) &&
                (a = viewProcessorApplyUserOverwrite(e, a, h, l, i, o, s));
            }),
            r.foreach((r, l) => {
              const h = pathChild(n, r);
              viewProcessorCacheHasChild(t, pathGetFront(h)) ||
      ...
      : (assert(l.source.fromServer, "Unknown source."),
        ...
        (s = viewProcessorApplyServerMerge(
          e,
          t,
          l.path,
          l.children,
    ...
    const a = n;
    s = a.revert
      ? (function viewProcessorRevertUserWrite(e, t, n, r, i, o) {
          let s;
          if (null != writeTreeRefShadowingWrite(r, n)) return t;
          {
            ...
            if (pathIsEmpty(n) || ".priority" === pathGetFront(n)) {
              ...
              if (t.serverCache.isFullyInitialized())
                n = writeTreeRefCalcCompleteEventCache(
                  r,
                  viewCacheGetCompleteServerSnap(t)
                );
              else {
                const e = t.serverCache.getNode();
                assert(
                  e instanceof ChildrenNode,
              ...
              null == c &&
                ...
                (c = l.getImmediateChild(i)),
                (h =
                  null != c
                    ? e.filter.updateChild(l, i, c, pathPopFront(n), a, o)
                ...
                h.isEmpty() &&
                  ...
                  ((s = writeTreeRefCalcCompleteEventCache(
                    r,
                    viewCacheGetCompleteServerSnap(t)
                  )),
            ...
            return (
              r.foreach((e, t) => {
                ...
                l.isCompleteForPath(r) &&
                  (h = h.set(e, l.getNode().getChild(r)));
              }),
...
function viewProcessorGenerateEventCacheAfterServerEvent(e, t, n, r, i, o) {
  ...
  if (null != writeTreeRefShadowingWrite(r, n)) return t;
  {
    ...
    if (pathIsEmpty(n))
      if (
        ...
        const n = viewCacheGetCompleteServerSnap(t),
          i = writeTreeRefCalcCompleteEventChildren(
            r,
            n instanceof ChildrenNode ? n : ChildrenNode.EMPTY_NODE
          );
        a = e.filter.updateFullNode(t.eventCache.getNode(), i, o);
      } else {
        const n = writeTreeRefCalcCompleteEventCache(
          r,
          viewCacheGetCompleteServerSnap(t)
        );
      ...
      if (".priority" === h) {
        ...
        if (s.isCompleteForChild(h)) {
          l = t.serverCache.getNode();
          const e = writeTreeRefCalcEventCacheAfterServerOverwrite(
            r,
            n,
            s.getNode(),
            l
          ...
          d =
            null != e
              ? s.getNode().getImmediateChild(h).updateChild(c, e)
              : s.getNode().getImmediateChild(h);
        } else d = writeTreeRefCalcCompleteChild(r, h, t.serverCache);
        a =
          null != d
            ? e.filter.updateChild(s.getNode(), h, d, c, i, o)
            : s.getNode();
      }
    }
    return viewCacheUpdateEventSnap(
      t,
      a,
      s.isFullyInitialized() || pathIsEmpty(n),
...
function viewProcessorApplyServerOverwrite(e, t, n, r, i, o, s, a) {
  ...
  if (pathIsEmpty(n)) h = c.updateFullNode(l.getNode(), r, null);
    ...
    h =
      ".priority" === e
        ? c.updatePriority(l.getNode(), o)
        : c.updateChild(l.getNode(), e, o, i, Q, null);
  }
  const d = viewCacheUpdateServerSnap(
    t,
    h,
  ...
  return viewProcessorGenerateEventCacheAfterServerEvent(
    ...
    n,
    i,
    new WriteTreeCompleteChildSource(i, d, o),
    a
  );
}
  ...
  if (pathIsEmpty(n))
    ...
    if (".priority" === i)
      ...
      if (pathIsEmpty(o)) d = r;
        ...
        d =
          null != e
            ? ".priority" === pathGetBack(o) &&
              e.getChild(pathParent(o)).isEmpty()
              ? e
              : e.updateChild(o, r)
            : ChildrenNode.EMPTY_NODE;
      }
      if (h.equals(d)) l = t;
        ...
        l = viewCacheUpdateEventSnap(
          t,
          e.filter.updateChild(a.getNode(), i, d, o, c, s),
          a.isFullyInitialized(),
          e.filter.filtersNodes()
        );
      }
...
function viewProcessorApplyServerMerge(e, t, n, r, i, o, s, a) {
  ...
  return (
    l.children.inorderTraversal((n, r) => {
      if (c.hasChild(n)) {
        const l = viewProcessorApplyMerge(
          0,
...
function viewGetCompleteServerCache(e, t) {
  ...
  return n &&
    (e.query._queryParams.loadsAllData() ||
      (!pathIsEmpty(t) && !n.getImmediateChild(pathGetFront(t)).isEmpty()))
    ? n.getChild(t)
    : null;
}
...
function syncPointApplyOperation(e, t, n, r) {
  ...
  if (null !== i) {
    ...
    return (
      assert(null != o, "SyncTree gave us an op for an invalid query."),
...
function syncPointGetView(e, t, n, r, i) {
  ...
  if (!s) {
    ...
    e
      ? (o = !0)
      : r instanceof ChildrenNode
      ? ((e = writeTreeRefCalcCompleteEventChildren(n, r)), (o = !1))
      : ((e = ChildrenNode.EMPTY_NODE), (o = !1));
...
function syncPointRemoveEventRegistration(e, t, n, r) {
  ...
  if ("default" === i)
    ...
    t &&
      ((s = s.concat(viewRemoveEventRegistration(t, n, r))),
      viewIsEmpty(t) &&
        (e.views.delete(i),
  ...
  return (
    a &&
      ...
      o.push(
        new ((function syncPointGetReferenceConstructor() {
...
function syncTreeApplyUserMerge(e, t, n, r) {
  ...
  return syncTreeApplyOperationToSyncPoints_(
    e,
    new Merge({ fromUser: !0, fromServer: !1, queryId: null, tagged: !1 }, t, i)
  );
}
...
function syncTreeRemoveEventRegistration(e, t, n, r, i = !1) {
  ...
  if (
    s &&
    ("default" === t._queryIdentifier || syncPointViewExistsForQuery(s, t))
  ) {
    ...
    if (((a = l.events), !i)) {
      const n = -1 !== h.findIndex((e) => e._queryParams.loadsAllData()),
        i = e.syncPointTree_.findOnPath(o, (e, t) =>
        ...
        if (!t.isEmpty()) {
          ...
          for (let t = 0; t < n.length; ++t) {
            ...
            e.listenProvider_.startListening(
              syncTreeQueryForListening_(i),
              syncTreeTagForQuery(e, i),
              o.hashFn,
              o.onComplete
            );
          }
...
function syncTreeApplyTaggedQueryOverwrite(e, t, n, r) {
  ...
  if (null != i) {
    ...
    return syncTreeApplyTaggedOperation_(
      e,
      o,
      new Overwrite(newOperationSourceServerTaggedQuery(s), a, n)
    );
  }
  return [];
}
function syncTreeAddEventRegistration(e, t, n, r = !1) {
  ...
  if (
    (l
      ? ((s = s || syncPointHasCompleteView(l)),
        (o = o || syncPointGetCompleteServerCache(l, newEmptyPath())))
      : ((l = new SyncPoint()),
  ...
  let c = syncPointAddEventRegistration(
    l,
    t,
    n,
    writeTreeChildWrites(e.pendingWriteTree_, i),
    o,
    a
  );
  if (!h && !s && !r) {
    ...
    c = c.concat(
      (function syncTreeSetupListener_(e, t, n) {
        ...
        if (i)
          assert(
            !syncPointHasCompleteView(a.value),
          ...
          const t = a.fold((e, t, n) => {
              ...
              return [syncPointGetCompleteView(t).query];
            {
              ...
              return (
                t &&
                  (e = e.concat(syncPointGetQueryViews(t).map((e) => e.query))),
                each(n, (t, n) => {
                  e = e.concat(n);
                }),
                e
          ...
          for (let n = 0; n < t.length; ++n) {
            ...
            e.listenProvider_.stopListening(
              syncTreeQueryForListening_(r),
              syncTreeTagForQuery(e, r)
            );
          }
        }
        return s;
...
function syncTreeGetServerValue(e, t) {
  ...
  i
    ...
    : ((i = new SyncPoint()), (e.syncPointTree_ = e.syncPointTree_.set(n, i)));
  const o = null != r,
  ...
  return (function viewGetCompleteNode(e) {
    ...
    syncPointGetView(
      i,
      t,
      writeTreeChildWrites(e.pendingWriteTree_, t._path),
      o ? s.getNode() : ChildrenNode.EMPTY_NODE,
      o
    )
  );
}
...
function syncTreeApplyOperationHelper_(e, t, n, r) {
    ...
    return syncTreeApplyOperationDescendantsHelper_(e, t, n, r);
  {
    ...
    null == n &&
      null != i &&
      (n = syncPointGetCompleteServerCache(i, newEmptyPath()));
    let o = [];
          ...
          ? (function syncTreeApplyTaggedListenComplete(e, t, n) {
              ...
              if (r) {
                ...
                return syncTreeApplyTaggedOperation_(
                  e,
                  i,
                  new ListenComplete(newOperationSourceServerTaggedQuery(o), s)
                );
              }
              return [];
            })(e, n._path, r)
...
function syncTreeQueryForListening_(e) {
  return e._queryParams.loadsAllData() && !e._queryParams.isDefault()
    ? new ((function syncTreeGetReferenceConstructor() {
...
const resolveDeferredLeafValue = function (e, t, n) {
  ...
  resolveComplexDeferredValue = function (e, t, n) {
    e.hasOwnProperty("increment") ||
      assert(!1, "Unexpected server value: " + JSON.stringify(e, null, 2));
    const r = e.increment;
    "number" != typeof r && assert(!1, "Unexpected increment value: " + r);
    const i = t.node();
    if (
      (assert(null != i, "Expected ChildrenNode.EMPTY_NODE for nulls"),
      !i.isLeafNode())
    )
      return r;
    const o = i.getValue();
...
function treeSubTree(e, t) {
  let n = t instanceof Path ? t : new Path(t),
    ...
    i = pathGetFront(n);
  for (; null !== i; ) {
    const e = safeGet(r.node.children, i) || { children: {}, childCount: 0 };
...
const H = /[\[\].#$\/\u0000-\u001F\u007F]/,
  ...
  validateFirebaseData = function (e, t, n) {
    ...
    if (void 0 === t)
      throw new Error(
        e + "contains undefined " + validationPathToErrorString(r)
      );
    if ("function" == typeof t)
      throw new Error(
        e +
          "contains a function " +
          validationPathToErrorString(r) +
          " with contents = " +
          t.toString()
      );
    if (isInvalidJSONNumber(t))
      throw new Error(
        e + "contains " + t.toString() + " " + validationPathToErrorString(r)
      );
    if (
      "string" == typeof t &&
      t.length > 10485760 / 3 &&
  ...
  validateFirebaseMergeDataArg = function (e, t, n, r) {
    ...
    each(t, (e, t) => {
      const r = new Path(e);
      if (
        (validateFirebaseData(i, t, pathChild(n, r)),
      ...
      (function (e, t) {
        ...
        let i = null;
        for (n = 0; n < t.length; n++) {
          if (((r = t[n]), null !== i && pathContains(i, r)))
            throw new Error(
              e +
                "contains a path " +
                i.toString() +
...
function eventQueueQueueEvents(e, t) {
  ...
  for (let r = 0; r < t.length; r++) {
    const i = t[r],
      o = i.getPath();
    null === n || pathEquals(o, n.path) || (e.eventLists_.push(n), (n = null)),
...
function eventQueueRaiseQueuedEventsMatchingPredicate(e, t) {
  ...
  for (let r = 0; r < e.eventLists_.length; r++) {
    ...
    if (i) {
      t(i.path)
        ? (eventListRaise(e.eventLists_[r]), (e.eventLists_[r] = null))
        : (n = !1);
    }
  }
...
function repoStart(e, t, n) {
  if (
    ((e.stats_ = statsManagerGetCollection(e.repoInfo_)),
    e.forceRestClient_ ||
      (
        ("object" == typeof window &&
          window.navigator &&
    ...
    (e.server_ = new ReadonlyRestClient(
      e.repoInfo_,
      (t, n, r, i) => {
    ...
    (e.persistentConnection_ = new PersistentConnection(
      e.repoInfo_,
      t,
      (t, n, r, i) => {
        repoOnDataUpdate(e, t, n, r, i);
  ...
  e.authTokenProvider_.addTokenChangeListener((t) => {
    ...
    (e.infoSyncTree_ = new SyncTree({
      startListening: (t, n, r, i) => {
        ...
        return (
          s.isEmpty() ||
            ((o = syncTreeApplyServerOverwrite(e.infoSyncTree_, t._path, s)),
            setTimeout(() => {
              i("ok");
            }, 0)),
          o
...
function repoGenerateServerValues(e) {
  return (
    ((t = (t = { timestamp: repoServerTime(e) }) || {}).timestamp =
...
function repoOnConnectStatus(e, t) {
  repoUpdateInfo(e, "connected", t),
    !1 === t &&
      (function repoRunOnDisconnectEvents(e) {
...
function repoSetWithPriority(e, t, n, r, i) {
  repoLog(e, "set", { path: t.toString(), value: n, priority: r });
...
function repoSendReadyTransactions(e, t = e.transactionQueueTree_) {
  if ((t || repoPruneCompletedTransactionsBelowNode(e, t), treeGetValue(t))) {
    ...
    n.every((e) => 0 === e.status) &&
      (function repoSendTransactionQueue(e, t, n) {
          ...
          (r) => {
            ...
            if ("ok" === r) {
              ...
              for (let t = 0; t < n.length; t++)
                (n[t].status = 2),
                  (i = i.concat(
                    syncTreeAckUserWrite(e.serverSyncTree_, n[t].currentWriteId)
                  )),
                  n[t].onComplete &&
                    r.push(() =>
                      n[t].onComplete(
              ...
              repoPruneCompletedTransactionsBelowNode(
                e,
                treeSubTree(e.transactionQueueTree_, t)
              ),
...
function repoRerunTransactions(e, t) {
  const n = repoGetAncestorTransactionNode(e, t),
    r = treeGetPath(n);
  return (
    (function repoRerunTransactionQueue(e, t, n) {
      ...
      for (let a = 0; a < t.length; a++) {
        ...
        if (
          ...
          (d = !0),
            (c = l.abortReason),
            (i = i.concat(
              syncTreeAckUserWrite(e.serverSyncTree_, l.currentWriteId, !0)
            ));
        else if (0 === l.status)
          if (l.retryCount >= 25)
            (d = !0),
            ...
            if (void 0 !== r) {
              ...
              ("object" == typeof r && null != r && contains(r, ".priority")) ||
        ...
        eventQueueRaiseEventsForChangedPath(e.eventQueue_, n, i),
          ...
          d &&
            ...
            t[a].onComplete &&
              ("nodata" === c
                ? r.push(() =>
                    t[a].onComplete(null, !1, t[a].currentInputSnapshot)
                  )
                : r.push(() => t[a].onComplete(new Error(c), !1, null))));
      }
      var s;
...
function repoGetAncestorTransactionNode(e, t) {
  ...
  for (n = pathGetFront(t); null !== n && void 0 === treeGetValue(r); )
    (r = treeSubTree(r, n)), (n = pathGetFront((t = pathPopFront(t))));
  return r;
}
      ...
      3 === n[t].status ||
        (1 === n[t].status
          ...
          : (assert(
            ...
            n[t].unwatcher(),
            (i = i.concat(
              syncTreeAckUserWrite(e.serverSyncTree_, n[t].currentWriteId, !0)
            )),
            n[t].onComplete &&
              r.push(n[t].onComplete.bind(null, new Error("set"), !1, null))));
...
const parseRepoInfo = function (e, t) {
      ...
      const u = (function decodeQuery(e) {
        ...
        for (const n of e.split("&")) {
          ...
          2 === r.length
            ...
            : warn(`Invalid query segment '${n}' in query '${e}'`);
        }
        return t;
  ...
  K = (function () {
    ...
    return function (n) {
      ...
      const o = new Array(8);
      for (i = 7; i >= 0; i--)
        (o[i] = z.charAt(n % 64)), (n = Math.floor(n / 64));
      assert(0 === n, "Cannot push at time == 0");
      let s = o.join("");
      if (r) {
        for (i = 11; i >= 0 && 63 === t[i]; i--) t[i] = 0;
        t[i]++;
      } else for (i = 0; i < 12; i++) t[i] = Math.floor(64 * Math.random());
...
class OnDisconnect {
  ...
  setWithPriority(e, t) {
    ...
    return (
      (function repoOnDisconnectSetWithPriority(e, t, n, r, i) {
  ...
  update(e) {
    ...
    const t = new Deferred();
    return (
      (function repoOnDisconnectUpdate(e, t, n, r) {
        if (isEmpty(n))
          return (
            log(
...
class QueryImpl {
  ...
  toString() {
    return (
      this._repo.toString() +
      (function pathToUrlEncodedString(e) {
        let t = "";
...
function validateQueryEndpoints(e) {
  ...
  if (
    ...
    (assert(
      e.getIndex() instanceof PathIndex || e.getIndex() === W,
      "unknown index type."
    ),
...
class DataSnapshot {
  ...
  forEach(e) {
    ...
    return !!this._node.forEachChild(this._index, (t, n) =>
      e(new DataSnapshot(n, child(this.ref, t), x))
    );
  }
  hasChild(e) {
    const t = new Path(e);
...
function push(e, t) {
  ...
  let s;
  return (
    (s = null != t ? set(o, t).then(() => o) : Promise.resolve(o)),
...
function update(e, t) {
  ...
  const n = new Deferred();
  return (
    (function repoUpdate(e, t, n, r) {
      repoLog(e, "update", { path: t.toString(), value: n });
      let i = !0;
      const o = repoGenerateServerValues(e),
        s = {};
      if (
...
function get(e) {
  ...
  return (function repoGetValue(e, t, n) {
    ...
    return null != r
      ...
      : e.server_.get(t).then(
          (r) => {
            ...
            let o;
            if (
              (syncTreeAddEventRegistration(e.serverSyncTree_, t, n, !0),
              ...
              o = syncTreeApplyTaggedQueryOverwrite(
                e.serverSyncTree_,
                t._path,
                i,
                n
          ...
          (n) => (
            repoLog(e, "get for query " + stringify(t) + " failed: " + n),
    ...
    (t) =>
      new DataSnapshot(
        t,
        new ReferenceImpl(e._repo, e._path),
...
class ValueEventRegistration {
  ...
  createEvent(e, t) {
    ...
    return new DataEvent(
      "value",
      this,
      new DataSnapshot(e.snapshotNode, new ReferenceImpl(t._repo, t._path), n)
    );
  }
  getEventRunner(e) {
...
class ChildEventRegistration {
  ...
  createEvent(e, t) {
    ...
    return new DataEvent(
      e.type,
      this,
      new DataSnapshot(e.snapshotNode, n, r),
      e.prevName
    );
  }
  getEventRunner(e) {
...
function addEventListener(e, t, n, r, i) {
  ...
  const s = new CallbackContext(n, o || void 0),
    a =
      "value" === t
        ? new ValueEventRegistration(s)
        : new ChildEventRegistration(t, s);
  return (
...
function off(e, t, n) {
  ...
  "value" === t
    ? (r = new ValueEventRegistration(i))
    : t && (r = new ChildEventRegistration(t, i)),
...
class QueryEndAtConstraint extends QueryConstraint {
  ...
  _apply(e) {
    ...
    if ((validateLimit(t), validateQueryEndpoints(t), e._queryParams.hasEnd()))
      throw new Error(
  ...
  _apply(e) {
    ...
    const t = (function queryParamsEndBefore(e, t, n) {
      ...
      return (
        (r =
          e.index_ === b || n
            ? queryParamsEndAt(e, t, n)
            : queryParamsEndAt(e, t, v)),
        (r.endBeforeSet_ = !0),
        r
      );
...
function endBefore(e, t) {
  return (
    validateKey("endBefore", "key", t, !0), new QueryEndBeforeConstraint(e, t)
  );
}
class QueryStartAtConstraint extends QueryConstraint {
  ...
  _apply(e) {
    ...
    if (
      (validateLimit(t), validateQueryEndpoints(t), e._queryParams.hasStart())
    )
      throw new Error(
  ...
  _apply(e) {
    ...
    const t = (function queryParamsStartAfter(e, t, n) {
      ...
      return (
        (r =
          e.index_ === b || n
            ? queryParamsStartAt(e, t, n)
            : queryParamsStartAt(e, t, C)),
        (r.startAfterSet_ = !0),
        r
      );
    })(e._queryParams, this._value, this._key);
...
function startAfter(e, t) {
  return (
    validateKey("startAfter", "key", t, !0), new QueryStartAfterConstraint(e, t)
  );
}
...
function equalTo(e, t) {
  return (
    validateKey("equalTo", "key", t, !0), new QueryEqualToValueConstraint(e, t)
  );
}
function query(e, ...t) {
...
function checkTransportInit() {
  TransportManager.IS_TRANSPORT_INITIALIZED &&
    warn(
...
function getDatabase(t = e(), n) {
  const r = _getProvider(t, "database").getImmediate({ identifier: n });
...
function goOnline(e) {
  (e = getModularInstance(e))._checkNotDeleted("goOnline"),
    (function repoResume(e) {
      e.persistentConnection_ &&
        e.persistentConnection_.resume("repo_interrupt");
    })(e._repo);
}
function enableLogging(e, t) {
  enableLogging$1(e, t);
}
const J = { ".sv": "timestamp" };
...
function runTransaction(e, t, n) {
  ...
  const i =
      null === (r = null == n ? void 0 : n.applyLocally) || void 0 === r || r,
    o = new Deferred(),
    s = onValue(e, () => {});
  return (
    (function repoStartTransaction(e, t, n, r, i, o) {
      ...
      if (void 0 === l)
        ...
        r.push(s),
          treeSetValue(n, r),
          "object" == typeof l && null !== l && contains(l, ".priority")
            ? ((i = safeGet(l, ".priority")),
              assert(
                isValidPriority(i),
                "Invalid priority returned by transaction. Priority must be a valid string, finite number, server value, or null."
              ))
            : (i = (
                syncTreeCalcCompleteEventCache(e.serverSyncTree_, t) ||
                ChildrenNode.EMPTY_NODE
              )
                .getPriority()
                .val());
        ...
        const d = syncTreeApplyUserOverwrite(
          e.serverSyncTree_,
          t,
          c,
          s.currentWriteId,
      ...
      (t, n, r) => {
        ...
        t
          ? o.reject(t)
          : ((i = new DataSnapshot(r, new ReferenceImpl(e._repo, e._path), x)),
...
const hijackHash = function (e) {
    ...
    return (
      (PersistentConnection.prototype.put = function (n, r, i, o) {
...
function _initStandalone({
  ...
  return (
    i &&
      ((l = new Provider("app-check-internal", s)),
