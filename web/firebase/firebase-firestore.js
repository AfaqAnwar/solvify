...
class __PRIVATE_WebChannelConnection extends class __PRIVATE_RestConnection {
  constructor(e) {
    ...
    (this.To = t + "://" + e.host),
      (this.Eo = `projects/${n}/databases/${i}`),
      (this.Ao =
            ...
            switch (l.getLastErrorCode()) {
              ...
              case De.TIMEOUT:
                __PRIVATE_logDebug(Mt, `RPC '${e}' ${s} timed out`),
                  u(
                    new FirestoreError(Ke.DEADLINE_EXCEEDED, "Request time out")
                  );
                break;
              case De.HTTP_ERROR:
                const n = l.getStatus();
  ...
  wo(e, t, n) {
    ...
    void 0 !== _ && (l.longPollingTimeout = Math.round(1e3 * _)),
      ...
      this.fo(l.initMessageHeaders, t, n),
...
class __PRIVATE_ExponentialBackoff {
  ...
  xo(e) {
    ...
    i > 0 &&
      __PRIVATE_logDebug(
        "ExponentialBackoff",
        `Backing off for ${i} ms (base delay: ${this.vo} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`
      ),
...
class __PRIVATE_PersistentStream {
  constructor(e, t, n, i, s, o, u, l) {
    (this.ii = e),
      ...
      (this.Qo = null),
      (this.stream = null),
      (this.Ko = new __PRIVATE_ExponentialBackoff(e, t));
  }
  $o() {
  ...
  zo() {
    this.Uo() &&
      null === this.qo &&
      (this.qo = this.ii.enqueueAfterDelay(this.Bo, 6e4, () => this.jo()));
  }
  Ho(e) {
  ...
  Vo(e, t, n) {
    return (
      ...
      Promise.all([
        ...
        .then(([i, s]) => this.connection.Vo(e, t, n, i, s))
        .catch((e) => {
  ...
  yo(e, t, n, i) {
    return (
      ...
      Promise.all([
        ...
        .then(([s, o]) => this.connection.yo(e, t, n, s, o, i))
        .catch((e) => {
          throw "FirebaseError" === e.name
            ? (e.code === Ke.UNAUTHENTICATED &&
                (this.authCredentials.invalidateToken(),
...
class __PRIVATE_OnlineStateTracker {
  ...
  set(e) {
    this.f_(), (this.T_ = 0), "Online" === e && (this.d_ = !1), this.R_(e);
  }
  R_(e) {
...
class __PRIVATE_RemoteStoreImpl {
  constructor(e, t, n, i, s) {
    (this.localStore = e),
      ...
      (this.b_ = new __PRIVATE_OnlineStateTracker(n, i));
  }
}
async function __PRIVATE_enableNetworkInternal(e) {
  if (__PRIVATE_canUseNetwork(e)) for (const t of e.w_) await t(!0);
}
...
function __PRIVATE_remoteStoreUnlisten(e, t) {
  ...
  n.p_.delete(t),
    i.Uo() && __PRIVATE_sendUnwatchRequest(n, t),
    0 === n.p_.size &&
      (i.Uo() ? i.zo() : __PRIVATE_canUseNetwork(n) && n.b_.set("Unknown"));
}
...
function __PRIVATE_shouldStartWatchStream(e) {
  return (
    ...
    !__PRIVATE_ensureWatchStream(e).$o() &&
    e.p_.size > 0
  );
}
...
async function __PRIVATE_onWatchStreamClose(e, t) {
  __PRIVATE_cleanUpWatchStreamState(e),
    __PRIVATE_shouldStartWatchStream(e)
      ? (e.b_.m_(t), __PRIVATE_startWatchStream(e))
      : e.b_.set("Unknown");
}
          ...
          return (
            n.targetChanges.forEach((n, i) => {
              if (n.resumeToken.approximateByteSize() > 0) {
                const s = e.p_.get(i);
                s && e.p_.set(i, s.withResumeToken(n.resumeToken, t));
              }
            }),
...
async function __PRIVATE_fillWritePipeline(e) {
  ...
  let i = t.g_.length > 0 ? t.g_[t.g_.length - 1].batchId : -1;
...
function __PRIVATE_shouldStartWriteStream(e) {
  return (
    __PRIVATE_canUseNetwork(e) &&
    !__PRIVATE_ensureWriteStream(e).$o() &&
    e.g_.length > 0
  );
}
...
async function __PRIVATE_onWriteStreamClose(e, t) {
  t &&
    __PRIVATE_ensureWriteStream(e).__ &&
    (await (async function __PRIVATE_handleWriteError(e, t) {
      if (
        ...
        const n = e.g_.shift();
        __PRIVATE_ensureWriteStream(e).Go(),
          await __PRIVATE_executeWithRecovery(e, () =>
...
async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  const n = __PRIVATE_debugCast(e);
  t
    ? (n.y_.delete(2), await __PRIVATE_enableNetworkInternal(n))
    : t ||
      (n.y_.add(2),
      await __PRIVATE_disableNetworkInternal(n),
      n.b_.set("Unknown"));
...
function __PRIVATE_ensureWatchStream(e) {
  return (
    e.v_ ||
      ((e.v_ = (function __PRIVATE_newPersistentWatchStream(e, t, n) {
        const i = __PRIVATE_debugCast(e);
        return (
          i.P_(),
...
function __PRIVATE_ensureWriteStream(e) {
  return (
    e.C_ ||
      ((e.C_ = (function __PRIVATE_newPersistentWriteStream(e, t, n) {
        const i = __PRIVATE_debugCast(e);
        return (
          i.P_(),
      ...
      e.w_.push(async (t) => {
        t
          ? (e.C_.Go(), await __PRIVATE_fillWritePipeline(e))
          : (await e.C_.stop(),
            e.g_.length > 0 &&
              (__PRIVATE_logDebug(
                "RemoteStore",
...
async function __PRIVATE_eventManagerListen(e, t) {
  ...
  n.queries.set(i, o),
    o.listeners.push(t),
    t.N_(n.onlineState),
    o.x_ && t.B_(o.x_) && __PRIVATE_raiseSnapshotsInSyncEvent(n);
}
...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
  ...
  for (const e of t) {
    const t = e.query,
      s = n.queries.get(t);
    if (s) {
      for (const t of s.listeners) t.B_(e) && (i = !0);
      s.x_ = e;
    }
  }
...
class __PRIVATE_BundleLoader {
  ...
  H_(e) {
    ...
    if (e.G_.namedQuery) this.queries.push(e.G_.namedQuery);
      ...
      e.G_.document &&
        ((this.documents[this.documents.length - 1].document = e.G_.document),
        ++t);
...
class __PRIVATE_View {
  constructor(e, t) {
    (this.query = e),
      ...
      (this.current = !1),
      (this.ta = __PRIVATE_documentKeySet()),
      (this.mutatedKeys = __PRIVATE_documentKeySet()),
      (this.na = __PRIVATE_newQueryComparator(e)),
      (this.ra = new DocumentSet(this.na));
  }
  get ia() {
    return this.X_;
  }
  sa(e, t) {
    const n = t ? t.oa : new __PRIVATE_DocumentChangeSet(),
      i = t ? t.ra : this.ra;
        ...
        h && d
          ? h.data.isEqual(d.data)
            ...
            : this._a(h, d) ||
              ...
              (g = !0),
              ((l && this.na(d, l) > 0) || (_ && this.na(d, _) < 0)) &&
                (u = !0))
          : !h && d
    ...
    return { ra: o, oa: n, zi: u, mutatedKeys: s };
  }
  _a(e, t) {
    return (
  ...
  applyChanges(e, t, n) {
    ...
    s.sort(
      ...
      this.aa(n);
    const o = t ? this.ua() : [],
      u = 0 === this.ta.size && this.current ? 1 : 0,
      l = u !== this.ea;
    return (
      (this.ea = u),
      0 !== s.length || l
  ...
  la(e) {
    return (
      !this.X_.has(e) && !!this.ra.has(e) && !this.ra.get(e).hasLocalMutations
    );
  }
  aa(e) {
    e &&
  ...
  ua() {
    ...
    return (
      e.forEach((e) => {
        this.ta.has(e) || t.push(new __PRIVATE_RemovedLimboDocument(e));
      }),
      this.ta.forEach((n) => {
...
class __PRIVATE_SyncEngineImpl {
  constructor(e, t, n, i, s, o) {
    (this.localStore = e),
      ...
      (this.Va = new Map()),
      (this.ma = new __PRIVATE_ReferenceSet()),
      (this.fa = {}),
      (this.ga = new Map()),
      (this.pa = __PRIVATE_TargetIdGenerator.On()),
      (this.onlineState = "Unknown"),
      (this.ya = void 0);
  }
  get isPrimaryClient() {
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, i, s) {
    ...
    (async function __PRIVATE_applyDocChanges(e, t, n, i) {
      ...
      s.zi &&
        (s = await __PRIVATE_localStoreExecuteQuery(
          ...
          t.query,
          !1
        ).then(({ documents: e }) => t.view.sa(e, s)));
      const o = i && i.targetChanges.get(t.targetId),
        u = t.view.applyChanges(s, e.isPrimaryClient, o);
      return __PRIVATE_updateTrackedLimbos(e, t.targetId, u.ca), u.snapshot;
    })(e, t, n, i);
  ...
  __PRIVATE_updateTrackedLimbos(e, n, h.ca);
    ...
    t.targetChanges.forEach((e, t) => {
      ...
      i &&
        ...
        e.addedDocuments.size > 0
          ...
          ? __PRIVATE_hardAssert(i.Ia)
          : e.removedDocuments.size > 0 &&
            (__PRIVATE_hardAssert(i.Ia), (i.Ia = !1)));
    }),
    ...
    i.Ea.forEach((n, i) => {
      ...
      (function __PRIVATE_eventManagerOnOnlineStateChange(e, t) {
        ...
        n.queries.forEach((e, n) => {
          for (const e of n.listeners) e.N_(t) && (i = !0);
        }),
          i && __PRIVATE_raiseSnapshotsInSyncEvent(n);
      })(i.eventManager, t),
      e.length && i.Ta.r_(e),
...
function __PRIVATE_processUserCallback(e, t, n) {
  const i = __PRIVATE_debugCast(e);
  let s = i.fa[i.currentUser.toKey()];
  if (s) {
    const e = s.get(t);
    e && (n ? e.reject(n) : e.resolve(), (s = s.remove(t))),
      (i.fa[i.currentUser.toKey()] = s);
  }
}
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  e.sharedClientState.removeLocalQueryTarget(t);
  for (const i of e.da.get(t)) e.Ea.delete(i), n && e.Ta.Sa(i, n);
  e.da.delete(t),
    e.isPrimaryClient &&
      e.ma.Ar(t).forEach((t) => {
        e.ma.containsKey(t) || __PRIVATE_removeLimboTarget(e, t);
      });
}
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const i of n)
    i instanceof __PRIVATE_AddedLimboDocument
      ? (e.ma.addReference(i.key, t), __PRIVATE_trackLimboChange(e, i))
      ...
      ? (__PRIVATE_logDebug(
        ...
        e.ma.containsKey(i.key) || __PRIVATE_removeLimboTarget(e, i.key))
      : fail();
}
...
function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
  for (; e.Aa.size > 0 && e.Ra.size < e.maxConcurrentLimboResolutions; ) {
    ...
    const n = new DocumentKey(ResourcePath.fromString(t)),
      i = e.pa.next();
    e.Va.set(i, new LimboResolution(n)),
      (e.Ra = e.Ra.insert(n, i)),
...
function __PRIVATE_syncEngineGetRemoteKeysForTarget(e, t) {
  const n = __PRIVATE_debugCast(e),
    i = n.Va.get(t);
  if (i && i.Ia) return __PRIVATE_documentKeySet().add(i.key);
  {
    let e = __PRIVATE_documentKeySet();
    const i = n.da.get(t);
    if (!i) return e;
...
async function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
  const n = __PRIVATE_debugCast(e),
    ...
    s = t.view.ha(i);
  return (
    n.isPrimaryClient && __PRIVATE_updateTrackedLimbos(n, t.targetId, s.ca), s
  );
}
...
function __PRIVATE_ensureWatchCallbacks(e) {
  ...
  return (
    ...
    (t.Ta.r_ = __PRIVATE_eventManagerOnWatchChange.bind(null, t.eventManager)),
    (t.Ta.Sa = __PRIVATE_eventManagerOnWatchError.bind(null, t.eventManager)),
    t
  );
}
...
class __PRIVATE_IndexedDbOfflineComponentProvider extends MemoryOfflineComponentProvider {
  ...
  async initialize(e) {
    await super.initialize(e),
      ...
      await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Da.syncEngine),
      await __PRIVATE_fillWritePipeline(this.Da.remoteStore),
            ...
            n.da.forEach((i, s) => {
              ...
              (function __PRIVATE_resetLimboDocuments(e) {
                ...
                t.Va.forEach((e, n) => {
                  ...
                  t.ma.Rr(),
                  (t.Va = new Map()),
                  (t.Ra = new SortedMap(DocumentKey.comparator));
              })(n),
              (n.ya = !1),
...
class __PRIVATE_BundleReaderImpl {
  constructor(e, t) {
    (this.Fa = e),
      ...
      (this.Ma = (function __PRIVATE_newTextDecoder() {
  ...
  async Oa() {
    ...
    const e = this.La();
    e < 0 &&
      this.Na("Reached the end of bundle when a length string is expected.");
  ...
  async lookup(e) {
    ...
    const t = await (async function __PRIVATE_invokeBatchGetDocumentsRpc(e, t) {
      const n = __PRIVATE_debugCast(e),
        ...
        o = await n.yo("BatchGetDocuments", i, s, t.length),
        u = new Map();
      o.forEach((e) => {
    ...
    !(function __PRIVATE_syncEngineLoadBundle(e, t, n) {
      ...
      (async function __PRIVATE_loadBundleImpl(e, t, n) {
        try {
          ...
          let o = await t.ba();
          for (; o; ) {
            const e = await s.H_(o);
            e && n._updateProgress(e), (o = await t.ba());
          }
...
class __PRIVATE_AsyncQueueImpl {
  constructor() {
    (this.Wa = Promise.resolve()),
      ...
      (this.Ya = !1),
      (this.Za = []),
      (this.Ko = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry")),
      (this.Xa = () => {
        const e = getDocument();
        e &&
          __PRIVATE_logDebug(
    ...
    return e.asyncQueue.enqueue(async () => {
      ...
      return (
        ...
        (function __PRIVATE_remoteStoreEnableNetwork(e) {
          const t = __PRIVATE_debugCast(e);
          return t.y_.delete(0), __PRIVATE_enableNetworkInternal(t);
        })(n)
      );
    });
  })(ensureFirestoreConfigured((e = __PRIVATE_cast(e, Firestore))));
...
class __PRIVATE_ParseContextImpl {
  ...
  Pu(e) {
    ...
    if (__PRIVATE_isWrite(this.uu) && Ot.test(e))
...
function __PRIVATE_parseSetData(e, t, n, i, s, o = {}) {
  const u = e.Ru(o.merge || o.mergeFields ? 2 : 0, t, n, s);
...
class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(this, e, !0),
      n = this.Vu.map((e) => __PRIVATE_parseData(e, t)),
...
function __PRIVATE_parseQueryValue(e, t, n, i = !1) {
  return __PRIVATE_parseData(n, e.Ru(i ? 4 : 3, t));
}
function __PRIVATE_parseData(e, t) {
  ...
  if ((t.path && t.fieldMask.push(t.path), e instanceof Array)) {
    ...
    return (function __PRIVATE_parseArray(e, t) {
      ...
      let i = 0;
      for (const s of e) {
        let e = __PRIVATE_parseData(s, t.Tu(i));
  ...
  return (function __PRIVATE_parseScalarValue(e, t) {
    ...
    throw t.Eu(`Unsupported field value: ${__PRIVATE_valueDescription(e)}`);
  })(e, t);
}
function __PRIVATE_parseObject(e, t) {
  ...
  return (
    isEmpty(e)
      ...
      : forEach(e, (e, i) => {
          const s = __PRIVATE_parseData(i, t.lu(e));
          null != s && (n[e] = s);
        }),
    { mapValue: { fields: n } }
  );
...
function __PRIVATE_validatePlainObject(e, t, n) {
  if (
    ...
    throw "an object" === i ? t.Eu(e + " a custom object") : t.Eu(e + " " + i);
  }
}
    ...
    return (
      e.asyncQueue.enqueueAndForget(async () =>
        (function __PRIVATE_addSnapshotsInSyncListener(e, t) {
          __PRIVATE_debugCast(e).O_.add(t), t.next();
        ...
        n.Ca(),
          e.asyncQueue.enqueueAndForget(async () =>
            (function __PRIVATE_removeSnapshotsInSyncListener(e, t) {
              __PRIVATE_debugCast(e).O_.delete(t);
            })(await __PRIVATE_getEventManager(e), n)
          );
      }
    );
          ...
          try {
            ...
            i.sharedClientState.addPendingMutation(e.batchId),
              (function __PRIVATE_addMutationCallback(e, t, n) {
                let i = e.fa[e.currentUser.toKey()];
                i || (i = new SortedMap(__PRIVATE_primitiveComparator)),
                  (i = i.insert(t, n)),
                  (e.fa[e.currentUser.toKey()] = i);
              })(i, e.batchId, n),
              await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(
                i,
                e.changes
          ...
          i.resolve(
            (async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
              ...
              const s = __PRIVATE_debugCast(e),
                ...
                l = o.parent;
              s.connection.Ro || delete o.parent;
              const _ = (await s.yo("RunAggregationQuery", l, o, 1)).filter(
                (e) => !!e.result
              );
